<template>
    <div class="main">
        <div class="search">
            <div>
                <el-input v-model="google.keyword" placeholder="请输入内容" class="input"
        ...
        <div class="search">
            <div>
                <el-input v-model="baidu.keyword" placeholder="请输入内容" class="input"
    ...
    data() {
        return {
            ...
            bookmarks: {
                ...
                "book": [
                    {"name": "起点孤儿院", "url": "https://www.qidian.com/"},
                ...
                "movie": [
                    ...
                    {"name": "年轻人的B站", "url": "https://www.bilibili.com/"},
                ...
                "work": [
                    ...
                    {"name": "禅道", "url": "http://192.168.0.158/zentao/my/"},
